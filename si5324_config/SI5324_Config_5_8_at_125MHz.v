...
//        SI5324 Config 5-8 at 125MHz generated from SI DSPLLsim software
//
// By Elliott Koehn
//
// Autogenerated on 2020/02/17 11:55:49
//
//////////////////////////////////////////////////////////////////////////////////

module SI5324_Config_5_8_at_125MHz#(
	...
	always @ (*) begin
		...
		6'd19: begin SI_DATA = {8'hD0,8'd25,8'h00}; end
		6'd20: begin SI_DATA = {8'hD0,8'd31,8'h00}; end
		6'd21: begin SI_DATA = {8'hD0,8'd32,8'h00}; end
		6'd22: begin SI_DATA = {8'hD0,8'd33,8'h09}; end
		6'd23: begin SI_DATA = {8'hD0,8'd34,8'h00}; end
		6'd24: begin SI_DATA = {8'hD0,8'd35,8'h00}; end
		6'd25: begin SI_DATA = {8'hD0,8'd36,8'h09}; end
		6'd26: begin SI_DATA = {8'hD0,8'd40,8'hC0}; end
		6'd27: begin SI_DATA = {8'hD0,8'd41,8'h00}; end
		6'd28: begin SI_DATA = {8'hD0,8'd42,8'hF9}; end
